...
function Cards(){
    ...
    return(
        <div className="flex justify-evenly lg:flex-row flex-col items-center bg-primary p-8">
            <div className="flex flex-col p-5 justify-around items-center border rounded border-white flex-1 lg:min-h-[400px]">
            ...
            <div className="lg:ml-10 lg:mt-0 mt-10 flex flex-col p-5 justify-around items-center border rounded border-white flex-1 lg:min-h-[400px]">
                <div className="flex flex-col justify-around items-center">

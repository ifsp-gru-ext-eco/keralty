...
function Home(){
 useEffect(() => {
    ...
    return(
        <div className="w-full h-screen flex lg:flex-row flex-col justify-evenly ">
            ...
            <div className="flex-1 flex items-center justify-center">
                <img data-aos="fade-left" data-aos-duration="1500" alt='Homem sentado sorrindo' className='w-[80%] md:w-[60%] lg:w-[50%] h-auto' src={homem}></img>
            </div>
        </div>
    );
